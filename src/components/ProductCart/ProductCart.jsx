	...
	return (
		<div className={classes.main_cart_wrap}>
			...
			<div className={classes.price_box}>
				<span className={classes.prevPrice}>{props.item.old_price} c.</span>
				<span className={classes.currentPrice}>{props.item.price} c.</span>
				<span className={classes.discount}>{props.item.discount}%</span>
			</div>
			<div className={classes.product_description}>
				...
				<div className={classes.size_description}>
					{props.item.size.map((item, i) => {
						return(
							<span key={item.id}>Размер: {item.size}</span>
						)
					})}
				</div>
			</div>
